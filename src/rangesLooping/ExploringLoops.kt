...
//    }
    ...
    println("(0..9).forEach { println(it) }")
    (0..9).forEach { println(it) }

    println("(9 downTo 0).forEach { println(it) }")
    (9 downTo 0).forEach { println(it) }

    println("(0 until 9).forEach {println(it)}")
    (0 until 9).forEach {println(it)}

    println("(0..9 step 2).forEach {println(it)}")
    (0..9 step 2).forEach {println(it)}

    println("('A'..'F').forEach {println(it)}")
